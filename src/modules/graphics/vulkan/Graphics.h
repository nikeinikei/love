...
private:
	...
	VkFramebuffer createFramebuffer(FramebufferConfiguration &configuration) const;
	VkFramebuffer getFramebuffer(FramebufferConfiguration &configuration);
	void createDefaultShaders();
	VkRenderPass createRenderPass(RenderPassConfiguration &configuration) const;
	...
	void endRenderPass();
	void applyScissor();
	VkSampler createSampler(const SamplerState &sampler) const;
